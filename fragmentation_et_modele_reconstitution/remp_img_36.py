...
dossier_images = "C:\\Users\\HP\\Desktop\\img_puzzle\\pieces36\\imge1"
...
for filename in os.listdir(dossier_images):
    if filename.endswith(".png"):  # Assurez-vous que le fichier est une image
        ...
        cursor.execute("INSERT INTO Images36Pieces (nom, image, image_complete_id) VALUES (?, ?, 0)", (filename, sqlite3.Binary(image_data)))
